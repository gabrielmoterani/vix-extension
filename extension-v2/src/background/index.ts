import { handleChatRequest, handleDomUpdated, handleGetState, handleImageAltRequest, handleImagesDetected, handleSummaryRequest, updateCurrentTab } from "./handlers/messageHandler"
