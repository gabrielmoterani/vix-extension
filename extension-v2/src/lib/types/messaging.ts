...
export type ExtensionMessage = DomUpdatedMessage | PageAnalyzedMessage | PageSummaryMessage | SummaryRequest | ChatRequest | ChatResponse | ImageAltRequest | ImageAltProgress | ImageAltCompleted